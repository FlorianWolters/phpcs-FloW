...
/**
 * This sniff prohibits the use of the PHP closing tag `?>`.
 *
 * @category  PHP
 * @package   PHP_CodeSniffer
 * @author    Florian Wolters <florian.wolters.85@googlemail.com>
 ...
 * @link      http://github.com/FlorianWolters/phpcs-FloW
 */
class FloW_Sniffs_PHP_DisallowCloseTagSniff
    implements PHP_CodeSniffer_Sniff
{
    ...
    {
        $errorMessage = 'A close tag is not permitted at the end of a PHP file';
        $violationCode = 'NotAllowed';
        $phpcsFile->addError($errorMessage, $stackPtr, $violationCode);
    }
